...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='MI-R4A-G'' package/lean/default-settings/files/zzz-default-settings
...
#sed -i 's/ssid=OpenWrt/ssid=MIWIFIR4AG/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
